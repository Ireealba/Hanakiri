...
public class donut : MonoBehaviour
{
    ...
    void Update()
    {
        playerDetectedL = spawnP.transform.GetComponent<donuBulletController>().playerDetectedL;
        playerDetectedR = spawnP.transform.GetComponent<donuBulletController>().playerDetectedR;
        ...
        if (moving)
        {
            ...
            if (!spawnP.transform.GetComponent<donuBulletController>().shooting)
            {
        ...
        else
        {
            ...
            if(spawnP.transform.GetComponent<donuBulletController>().actualCooldownAttack < 0)
            {

                spawnP.transform.GetComponent<donuBulletController>().Shoot();
